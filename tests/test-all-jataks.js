/**
 * test-all-jataks.js
 * Validates all jataks from JATAKS_DATABASE.json
...
test(`All ${db.totalJataks} jataks loaded`, () => {
  assert(db.jataks.length === db.totalJataks, `Expected ${db.totalJataks}, got ${db.jataks.length}`);
});
...
console.log(`Jataks tested: ${db.jataks.length}/${db.totalJataks}`);
