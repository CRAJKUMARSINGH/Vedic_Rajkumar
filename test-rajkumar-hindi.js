// Test transit calculations for Rajkumar - Hindi Display
// Birth: 15 Sep 1963, 6:00 AM, Aspur, Dungarpur (23.84°N, 73.71°E)
...
// Rajkumar's natal Moon is in Cancer (Karka) - index 3
const MOON_RASHI_INDEX = 3;
...
function calculateTransits() {
  ...
  console.log("\n" + "=".repeat(80));
  console.log("🕉️  गोचर फल विश्लेषण - राजकुमार");
  console.log("=".repeat(80));
  console.log("जन्म विवरण: 15 सितम्बर 1963, प्रातः 6:00 बजे");
  console.log("जन्म स्थान: आसपुर, डूंगरपुर, राजस्थान (23.84°N, 73.71°E)");
  console.log("चन्द्र राशि: कर्क (Cancer)");
