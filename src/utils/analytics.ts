...
// Auto-initialize on import - DISABLED
// GDPR COMPLIANCE: Analytics must be initialized manually after user consent
// Call analytics.initialize() only after explicit user cookie consent
// if (typeof window !== 'undefined') { analytics.initialize(); }
