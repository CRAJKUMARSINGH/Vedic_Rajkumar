...
import { type FeedbackType, type FeedbackCategory } from '@/services/feedbackService';
import { submitFloatingFeedbackDual } from '@/services/unifiedFeedbackSubmit';
...
export const FeedbackWidget: React.FC<FeedbackWidgetProps> = ({ language = 'en' }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await submitFloatingFeedbackDual({
      type,
      category,
      title,
      description,
