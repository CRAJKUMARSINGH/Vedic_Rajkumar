...
const SpiritualRemediesPage = () => {
  ...
  const yantras = recommendYantras([], []);
  const rudraksha = recommendRudraksha([], []);
              ...
              <div className="space-y-3">
                {mantras.slice(0,8).map((m: any) => (
                  <div key={m.id} className="bg-card border rounded-xl p-4">
                    ...
                    <p className="text-xs text-muted-foreground">{isHi?m.benefits?.hi?.join(", "):m.benefits?.en?.join(", ")}</p>
                ...
                <div key={r.mukhi} className="bg-card border rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">{isHi?r.benefits?.hi?.join(", "):r.benefits?.en?.join(", ")}</p>
