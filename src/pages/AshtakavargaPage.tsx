...
const EnhancedAshtakavargaDashboard = lazy(() => import('@/components/EnhancedAshtakavargaDashboard'));
            ...
            <Tabs defaultValue="chart" className="space-y-4">
              ...
              <TabsContent value="extended" className="mt-0">
                <p className="text-xs text-muted-foreground mb-4">
                  {isHi
                    ? 'डेमो डेटा पर आधारित विस्तृत अष्टकवर्ग दृश्य।'
                    : 'Extended Ashtakavarga view with demo data.'}
                </p>
                <Suspense fallback={<div className="flex justify-center py-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary" /></div>}>
                  <EnhancedAshtakavargaDashboard />
                </Suspense>
              </TabsContent>
            </Tabs>
          )}
