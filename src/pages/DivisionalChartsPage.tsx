...
const DivisionalChartsDashboard = lazy(() => import('@/components/DivisionalChartsDashboard'));
            ...
            <Tabs defaultValue="chart" className="space-y-4">
              ...
              <TabsContent value="extended" className="mt-0">
                <p className="text-xs text-muted-foreground mb-4">
                  {isHi
                    ? 'डेमो डेटा पर आधारित विस्तृत विभाजन चार्ट दृश्य।'
                    : 'Extended divisional-chart view with demo data.'}
                </p>
                <Suspense fallback={<Loader />}>
                  <DivisionalChartsDashboard />
                </Suspense>
              </TabsContent>
            </Tabs>
          )}
